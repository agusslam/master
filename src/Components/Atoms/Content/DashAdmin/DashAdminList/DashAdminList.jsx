...
class AdmindashboardLis extends React.Component {
                ...
                <Row className="wrapper-dashburd2">
                    ...
                    <Col md="9">
                        <Row className="wrapper-side-right2">
                            <Col md="12">
                                <h2 className="title-dashburd">List Debitur</h2>
                            </Col>
                            <Col md="12" className="wrapper-side-right12">
                                <Row className="wrap-ajukan2">
                                    <Col md="12"><h5>List Debitur KPR</h5></Col>
...
export default connect(mapsStateToProps, mapsDispatchToProps)(AdmindashboardLis)