        ...
        return (
            <Col md="3" className="wrapper-side-left">
                <Row className="wrapper-side-left-menu">
                    ...
                    <Col md="12" className="wrap-ico">
                    <Nav.Link className="nav-style-user" href="/adminlist" active={this.props.location.pathname.startsWith('/adminlist')}><img className="ico" src={icoSimulasi} alt="debiturlst" />My Debitur List</Nav.Link>
                    </Col>
                    <Col md="12" className="wrap-ico">
