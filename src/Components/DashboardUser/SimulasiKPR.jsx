...
import DashUserSimulasi from '../Atoms/Content/DashUser/DashUserSimulasi/DashSimulasi'
import Foot from '../Atoms/Footer/Home/Footer'


class DashboardSimulasi extends React.Component {
    render() {
        ...
        return (
            <Container fluid={true} className="p-0">
                ...
                <Route component={DashUserSimulasi} />  
                <Foot />
            </Container>
        )
    }
...
export default connect(mapsStateToProps)(DashboardSimulasi)