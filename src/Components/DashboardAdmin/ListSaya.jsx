...
import DashAdminListSaya from '../Atoms/Content/DashAdmin/DashAdminList/DashAdminList'
import Foot from '../Atoms/Footer/Home/Footer'


class DashboardAdminLst extends React.Component {
    render() {
        ...
        return (
            <Container fluid={true} className="p-0">
                ...
                <Route component={DashAdminListSaya} />  
                <Foot />
            </Container>
        )
    }
...
export default connect(mapsStateToProps)(DashboardAdminLst)